...
function enqueue_script_func() {
	...
	// wp_enqueue_script('moment-timezone-js', get_template_directory_uri() . '/assets/moment-timezone.min.js', array('moment-js'), '1.0', true);
	wp_enqueue_script('moment-timezone-js', get_template_directory_uri() . '/assets/moment-timezone-with-data.min.js', array('moment-js'), '1.0', true);
